...
const MapSection = () => (
  <div className="w-full max-w-6xl flex flex-col items-center h-96">
...
const GallerySection = ({ imageId }) => (
  <div className="h-full w-full flex flex-col items-center">
    ...
    <div className=" h-[25rem] w-full flex flex-col items-center">
      <Carousel>
...
function Venue() {
  ...
  return (
    <section
      id="venue-and-dates" className="flex flex-col justify-center items-center h-full w-full m-7">
      <h2 className="text-5xl font-bold mb-2">Venue</h2>
      <p className="text-3xl mb-2 text-indigo-700 font-bold">
        National Institute of Technology Delhi
      </p>
      ...
      <div
        className="flex flex-col lg:flex-row justify-center lg:text-gray-950 mt-12 h-full w-full"
      >
        <MapSection />
