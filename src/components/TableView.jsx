function TableView(props) {
    ...
    return (
        <div id={`${props.tableName}`} className={`pl-8 pr-8 pt-0 pb-0 sm:p-0 sm:ml-32  sm:mt-10 mb-5 `}>
            {props.tableName?.length > 0 && <h1 className="font-bold sm:text-4xl text-2xl text-gray-800">{props.tableName}</h1>}
