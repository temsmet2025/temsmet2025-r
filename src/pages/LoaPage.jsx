...
const LoaPage = () => {
    return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 w-full gap-1">
          <div id="camera-ready-paper" className="sm:col-span-3 md:col-span-4 lg:col-span-6 xl:col-span-8 p-5 bg-slate-50 rounded-b-xl sm:rounded-l-none sm:rounded-r-xl">
            <Countdown />
